            ...
            <div className="custom-screen flex flex-col-reverse gap-x-12 justify-between md:flex-row md:items-center">
                <div className="flex-none max-w-xl mt-12 space-y-3 md:mt-0">
                    ...
                    <p className="text-gray-600">
                        Split is a new, revolutionary & cost-effective way to grow your website&apon;s traffic. It&apon;s a super-simple, one-time fee that will make your site rank higher on Google and bring in more visitors. We&apon;re so confident, we offer a 100% money back guarantee.
                    </p>
                    <div className="pt-1">
                        <NavLink
                            href="/pricing"
