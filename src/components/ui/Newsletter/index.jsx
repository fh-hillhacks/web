...
const Newsletter = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch(`https://formspree.io/f/mdknzbbp`, {
      method: 'POST',
      headers: {
  ...
  return (
    <div className="mt-6 md:mt-0">
      ...
      <form onSubmit={handleSubmit} className="mt-6 flex items-center gap-x-3">
        ...
        <Button type="submit" className="block w-auto text-white bg-blue-600 hover:bg-blue-500 ring-offset-2 ring-blue-600 focus:ring shadow rounded-lg">
          Subscribe
        </Button>
      </form>
    </div>
